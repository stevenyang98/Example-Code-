...
program albertaITC, rclass 
	//args appear in chronological order when you look at the form
	...
	if `associated'==1 {
		...
		if inrange(td(29feb2004),td(`startDate'),td(`endDate'))==1 | inrange(td(29feb2008),td(`startDate'),td(`endDate'))==1 | inrange(td(29feb2012),td(`startDate'),td(`endDate'))==1 | inrange(td(29feb2016),td(`startDate'),td(`endDate'))==1 {
	...
	return scalar refundableITC=`netRepaymentCredit'
